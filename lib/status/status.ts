...
// Chart colors for the 6 internal statuses (analytics dashboard "Theo trạng thái").
export const STATUS_COLOR: Record<TicketStatus, string> = {
  Pending: "#f59e0b", // chờ tiếp nhận
  Assigned: "#3b82f6", // đã giao phòng ban
  InProgress: "#6366f1", // đang xử lý
  CloseRequested: "#f97316", // chờ duyệt đóng
  RedirectRequested: "#8b5cf6", // chờ duyệt chuyển
  Closed: "#22c55e", // đã đóng
};
...
export function backlogAgeDays(
  createdAtIso: string,
  now: Date = new Date(),
): number {
